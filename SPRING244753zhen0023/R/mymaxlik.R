...
#'
#' @param lfun function used for the matrix
#' @param x number of rows in the matrix created
#' @param param parameter values
#' @param ... additional inputs/arguments
...
#' @export
#'
#' @examples lfun = function(x, theta)
#' mymaxlik(lfun, x = 100, param=100)
